...
import com.chen.authorization.CaptchaAuthenticationProvider;
...
public class SmsCaptchaLoginAuthenticationProvider extends CaptchaAuthenticationProvider {
    ...
    protected void additionalAuthenticationChecks(UserDetails userDetails, UsernamePasswordAuthenticationToken authentication) throws AuthenticationException {
        ...
        if (Objects.equals(loginType, SecurityConstants.SMS_LOGIN_TYPE)
            ...
            String smsCaptcha = redisCache.getCacheObject((SMS_CAPTCHA_PREFIX_KEY + authentication.getPrincipal()));
